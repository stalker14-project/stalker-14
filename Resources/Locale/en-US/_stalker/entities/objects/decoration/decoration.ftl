...
ent-OldGen = Old Generator
    ...
    .suffix = { ent-WoodenCrib.suffix }
ent-GasStationstalkertwo = gas station
    .desc = An old gas station, it's unlikely that it works.
    .suffix = ST, Mapping
ent-GasStationstalkernew = { ent-GasStationstalkertwo }
    .desc = { ent-GasStationstalkertwo.desc }
    .suffix = { ent-GasStationstalkertwo.suffix }
ent-GasStationstalkernewtwo = { ent-GasStationstalkertwo }
    .desc = { ent-GasStationstalkertwo.desc }
    .suffix = { ent-GasStationstalkertwo.suffix }
ent-WoodenKomod = old Soviet dresser
    .desc = A bulky dresser from the Soviet era with characteristic geometric patterns and metal overlays. Despite its clumsy appearance, its sturdiness commands respect — such furniture will survive any changes.
    .suffix = { ent-GasStationstalkertwo.suffix }
