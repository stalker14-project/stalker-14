...
ent-ClothingBackpackStalkerZaryaGreen = Stalker backpack "Zarya"
    .desc = Spacious stalker backpack in olive color from the "Zarya" set, often used as a stash.
    .suffix = ST
ent-ClothingBackpackStalkerZaryaBlack = { ent-ClothingBackpackStalkerZaryaGreen }
    .desc = Spacious stalker backpack in black color from the "Zarya" set, often used as a stash.
