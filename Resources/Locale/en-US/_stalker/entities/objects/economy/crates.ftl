...
ent-ArmyAKC1Crate = OKSOP AKS PSZ-7 kit
...
ent-BulkScienceCrate = Scientific Medical Box
    .desc = A bulk crate filled with scientific first aid kits.
ent-BulkEliteCrate = Elite Medical Box
    .desc = A bulk crate filled with elite first aid kits.
ent-BulkLARCrate = LAR Medical Box
    .desc = A bulk crate filled with LAR first aid kits.
...
ent-StalkerBasedCrate = basic gear kit
    ...
    .suffix = { ent-StalkerHunterCrate.suffix }
ent-ArmyAKCUCrate = OKSOP Seva Kit
