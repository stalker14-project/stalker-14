using Content.Shared._Stalker.StalkerCCVars;
using Content.Shared._Stalker.TapePlayer;
using Robust.Client.GameObjects;
using Robust.Shared.Configuration;

namespace Content.Client._Stalker.TapePlayer
{
    public sealed class TapePlayerSystem : SharedTapePlayerSystem
    {
        ...
        public override void Initialize()
        {
            ...
            _cfg.OnValueChanged(StalkerCCVars.TapePlayerClientEnabled, OnTapePlayerClientOptionChanged, true);
        }

        public override void Shutdown()
        {
            base.Shutdown();
            _cfg.UnsubValueChanged(StalkerCCVars.TapePlayerClientEnabled, OnTapePlayerClientOptionChanged);
        }
